...
function setup(){
  ...
  bob1 = new Pendulum(455,300,88)
  bob2 = new Pendulum(515,300,88)
  bob3 = new Pendulum(575,300,88)
  bob4 = new Pendulum(635,300,88)
  bob5 = new Pendulum(695,300,88)
  bob6 = new Pendulum(755,300,88)
  ...
  sling6 = new Sling(bob6.body,{x:755,y:50});
